...
```
# Output:
<img width="461" height="257" alt="image" src="https://github.com/user-attachments/assets/e0b82b25-e576-46c9-9a35-ba8eee61d4c0" />
...
```
# Output:
<img width="647" height="502" alt="image" src="https://github.com/user-attachments/assets/ec72a165-ee96-4095-b28d-645968d50025" />
...
```
# Output:
<img width="655" height="247" alt="image" src="https://github.com/user-attachments/assets/a55e7321-7860-4b21-862f-f9bef3a7eb19" />
...
```
# Output:
<img width="638" height="361" alt="image" src="https://github.com/user-attachments/assets/ea8286c8-07b9-4adb-82e5-06dec5275b60" />
...
int main() {
    ...
    printf("Sentence after removing duplicate words: ");
    for (i = 0; i < w; i++) {
        if (words[i][0] != '\0') {
            printf("%s ", words[i]);
        }
...
```
# Output:
<img width="636" height="250" alt="image" src="https://github.com/user-attachments/assets/a52d8f5a-e642-46a0-80ee-490b4500e833" />
